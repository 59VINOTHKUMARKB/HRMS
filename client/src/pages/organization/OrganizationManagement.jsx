...
import { 
  FiUsers, FiLayers, FiGitBranch, FiUserPlus,
  FiEdit2, FiTrash2, FiPlus, FiDownload,
  FiChevronRight, FiMapPin
} from 'react-icons/fi';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { label: 'Total Employees', value: '248', icon: FiUsers, color: 'blue' },
                ...
                <div key={location.id} className="border rounded-lg p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-4">
                    <div className="bg-gray-50 rounded p-3">
                      ...
                      <p className="text-lg font-medium">{location.employees}</p>
                    </div>
                    <div className="bg-gray-50 rounded p-3">
                      <p className="text-sm text-gray-500">Departments</p>
                      <p className="text-lg font-medium">{location.departments}</p>
                    </div>
                  </div>
                </div>
              ))}
