...
import { 
  FiUserPlus, FiCheckSquare, FiClock, FiCalendar,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        {[
          { label: 'Active Onboarding', value: '12', icon: FiUserPlus, color: 'blue' },
          { label: 'Completed Tasks', value: '45', icon: FiCheckSquare, color: 'green' },
          { label: 'Pending Tasks', value: '28', icon: FiClock, color: 'yellow' },
          { label: 'Starting This Month', value: '8', icon: FiCalendar, color: 'purple' },
        ].map((stat, index) => (
